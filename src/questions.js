...
export const questions = [
    ...
    },
    {
        ...
        answers: [
            {
                text: `const { age, name } = myObject;`,
            },
            {
                text: `const age = myObject[age];\nconst name = myObject[name];`,
            },
            {
                text: `const age, name = myObject;`,
            },
            ...
            {
                text: `const myObject[age], myObject[name];`,
            },
        ],
        answerType: `code`,
        correctAnswer: 1,
    },
    {
        ...
        answers: [
            {
                text: `\`import\` is used for passing variables into a function where \`export\` is used for passing variables out of a function`,
            },
            {
                text: `\`import\` and \`export\` are both used when you want to handle different languages in your application`,
            },
            {
                text: `\`import\` and \`export\` are used to keep your modules (functions, classes, etc.) in separate files`,
            },
        ],
        answerType: `markdown`,
        correctAnswer: 3,
